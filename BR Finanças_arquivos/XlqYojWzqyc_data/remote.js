...
L:"ytp-mdx-manual-pairing-popup-dialog",W:{role:"dialog"},U:[{G:"div",L:"ytp-mdx-manual-pairing-popup-dialog-inner-content",U:[{G:"div",L:"ytp-mdx-manual-pairing-popup-title",va:"Em breve, n\u00e3o ser\u00e1 mais poss\u00edvel usar um c\u00f3digo na Web para conectar o YouTube \u00e0 sua TV"},{G:"div",L:"ytp-mdx-manual-pairing-popup-buttons",U:[{G:"button",Ga:["ytp-button","ytp-mdx-manual-pairing-popup-learn-more"],va:"Saiba mais"},{G:"button",Ga:["ytp-button","ytp-mdx-manual-pairing-popup-ok"],va:"OK"}]}]}]});
this.i=new g.zL(this,250);this.learnMoreButton=this.Fa("ytp-mdx-manual-pairing-popup-learn-more");this.okButton=this.Fa("ytp-mdx-manual-pairing-popup-ok");g.J(this,this.i);this.T(this.learnMoreButton,"click",this.u);this.T(this.okButton,"click",this.B)},C9=function(){g.U.call(this,{G:"div",
...
Ga:["ytp-button","ytp-mdx-privacy-popup-cancel"],va:"Cancelar"},{G:"button",Ga:["ytp-button","ytp-mdx-privacy-popup-confirm"],va:"Confirmar"}]}]}]});this.i=new g.zL(this,250);this.cancelButton=this.Fa("ytp-mdx-privacy-popup-cancel");this.confirmButton=this.Fa("ytp-mdx-privacy-popup-confirm");g.J(this,this.i);this.T(this.cancelButton,"click",this.u);this.T(this.confirmButton,"click",this.B)},D9=function(a){g.U.call(this,{G:"div",
...
b=g.T(b,128)?g.qI("Erro em $RECEIVER_NAME",c):b.Ac()||g.T(b,4)?g.qI("Reproduzindo em $RECEIVER_NAME",c):g.qI("Conectado a $RECEIVER_NAME",c);a.Ra("statustext",b);a.i.show()}else a.i.hide()},E9=function(a,b){g.NP.call(this,"Reproduzir em",0,a,b);
...
E9.prototype.bj=function(a){return"cast-selector-receiver"===a?"Elenco...":this.oo[a].name};
